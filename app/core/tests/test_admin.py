...
class AdminSiteTests(TestCase):
    ...
    def test_users_listed(self):
        ...
        url = reverse(
            "admin:core_user_changelist")  # Generate the URL for our list user page
        res = self.client.get(url)  # Perform an HTTP GET request on the URL

        # Check that the response contains a certain item
    ...
    def test_edit_user_page(self):
        ...
        url = reverse("admin:core_user_change", args=[
                      self.user.id])  # Generate the URL for the user edit page
        res = self.client.get(url)  # Perform an HTTP GET request on the URL
    ...
    def test_create_user_page(self):
        ...
        url = reverse(
            "admin:core_user_add")  # Generate the URL for the user add page
        res = self.client.get(url)  # Perform an HTTP GET request on the URL
