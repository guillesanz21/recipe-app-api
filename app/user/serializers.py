...
class AuthTokenSerializer(serializers.Serializer):
  ...
  password = serializers.CharField(
    style={'input_type': 'password'},  # Optional, but it makes the input field a password field in the browsable API.
    trim_whitespace=False  # This is to allow for leading and trailing whitespace in the password.
  )
